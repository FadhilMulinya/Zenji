// @ts-nocheck
import { InjectiveGrpcBase } from "../grpc/grpc-base.ts";
import type { Network } from "@injectivelabs/networks";

import * as AuctionModule from "./auction.ts";
import * as AuthModule from "./auth.ts";
import * as AuthZModule from "./authz.ts";
import * as BankModule from "./bank.ts";
import * as DistributionModule from "./distribution.ts";
import * as ExchangeModule from "./exchange.ts";
import * as GovernanceModule from "./gov.ts";
import * as IbcModule from "./Ibc.ts";
import * as InsuranceFundModule from "./insurance.ts";
import * as MintModule from "./mint.ts";
import * as MitoModule from "./mito.ts";
import * as ExplorerModule from "./explorer.ts";
import * as OracleModule from "./oracle.ts";
import * as PeggyModule from "./peggy.ts";
import * as PermissionsModule from "./permissions.ts";
import * as StakingModule from "./staking.ts";
import * as TokenFactoryModule from "./token-factory.ts";
import * as WasmModule from "./wasm.ts";
import * as WasmXModule from "./wasmx.ts";
...
export class InjectiveGrpcClient extends InjectiveGrpcBase {
	...
	public getAuctionModuleState = AuctionModule.getAuctionModuleState.bind(this);
	...
	public getTradeRewardPoints = ExchangeModule.getTradeRewardPoints.bind(this);
	public getPendingTradeRewardPoints =
		ExchangeModule.getPendingTradeRewardPoints.bind(this);
	public getExchangePositions = ExchangeModule.getExchangePositions.bind(this);
	...
	//===========================INDEXER==============================
	public getDerivativeMarkets = ExchangeModule.getDerivativeMarkets.bind(this);
	...
	public getSubaccountHistory = ExchangeModule.getSubaccountHistory.bind(this);
	...
	public getAtomicSwapHistory = ExchangeModule.getAtomicSwapHistory.bind(this);
	public getGridStrategies = ExchangeModule.getGridStrategies.bind(this);
	public getHistoricalBalance = ExchangeModule.getHistoricalBalance.bind(this);
	public getHistoricalRpnl = ExchangeModule.getHistoricalRpnl.bind(this);
	public getHistoricalVolumes = ExchangeModule.getHistoricalVolumes.bind(this);
	...
	public getProposalDeposits = GovernanceModule.getProposalDeposits.bind(this);
	...
	//Oracle functions
	public getOracleModuleParams = OracleModule.getOracleModuleParams.bind(this);
	//Peggy functions
	...
	public getNamespaceByDenom = PermissionsModule.getNamespaceByDenom.bind(this);
	...
	public getDelegationsNoThrow = StakingModule.getDelegationsNoThrow.bind(this);
