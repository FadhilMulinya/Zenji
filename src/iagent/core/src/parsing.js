...
exports.parseActionResponseFromText = exports.postActionResponseFooter = exports.normalizeJsonString = exports.stringArrayFooter = exports.parseBooleanFromText = exports.booleanFooter = exports.parseShouldRespondFromText = exports.shouldRespondFooter = exports.messageCompletionFooter = void 0;
exports.parseJsonArrayFromText = parseJsonArrayFromText;
exports.parseJSONObjectFromText = parseJSONObjectFromText;
exports.extractAttributes = extractAttributes;
exports.cleanJsonResponse = cleanJsonResponse;
exports.truncateToCompleteSentence = truncateToCompleteSentence;
const jsonBlockPattern = /```json\n([\s\S]*?)\n```/;
exports.messageCompletionFooter = `\nResponse format should be formatted in a valid JSON block like this:
\`\`\`json
...
`;
exports.shouldRespondFooter = `The available options are [RESPOND], [IGNORE], or [STOP]. Choose the most appropriate option.
If {{agentName}} is talking too much, you can choose [IGNORE]

Your response must include one of the options.`;
const parseShouldRespondFromText = (text) => {
    const match = text
        .split("\n")[0]
        .trim()
        .replace("[", "")
...
exports.parseShouldRespondFromText = parseShouldRespondFromText;
exports.booleanFooter = `Respond with only a YES or a NO.`;
/**
 ...
 */
const parseBooleanFromText = (text) => {
    if (!text)
...
exports.parseBooleanFromText = parseBooleanFromText;
exports.stringArrayFooter = `Respond with a JSON array containing the values in a valid JSON block formatted for markdown with this structure:
\`\`\`json
[
  'value',
  'value'
...
function parseJSONObjectFromText(text) {
    ...
    if (jsonBlockMatch) {
        ...
        const parsingText = (0, exports.normalizeJsonString)(text);
        try {
...
exports.normalizeJsonString = normalizeJsonString;
/**
...
exports.postActionResponseFooter = `Choose any combination of [LIKE], [RETWEET], [QUOTE], and [REPLY] that are appropriate. Each action must be on its own line. Your response must only include the chosen actions.`;
const parseActionResponseFromText = (text) => {
    const actions = {
        like: false,
        retweet: false,
        quote: false,
...
exports.parseActionResponseFromText = parseActionResponseFromText;
/**
